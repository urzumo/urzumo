...
| 04. Сегментация клиентов банка ([github](https://github.com/urzumo/data_analysis_projects/tree/main/segmentaciya_clientov_banka) / [nbviewer](здесь будет ссылка)) | Анализ данных, сегментация, статистическая проверка гипотез
