...
В разделе **Реализованные проекты** находятся законченные проекты и мой прогресс в Data Science, Data Analysis и ML. Ссылки этого раздела ведут на соответствующие репозитарии. Кроме того, отдельным блоком ниже расположены ссылки на каждый проект через <a href="https://nbviewer.org">сторонний сервис nbviewer</a></p>.
