...
В разделе **Репозитории проектов** находятся ссылки на репозитории, разбитые по темам. В них находятся законченные проекты (для ретроспективы моего прогресса в Data Science, Data Analysis и ML). Каждый репозиторий снабжен удобной таблицей, содержащей наименование проекта, его краткое описание и ссылки на github / <a href="https://nbviewer.org">сторонний сервис nbviewer</a>. Эта же таблица продублирована в разделе **Реализованные проекты**.
