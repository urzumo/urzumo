...
В разделе **Репозитории проектов** содержатся ссылки на отдельные репозитории, по тематикам проектов. Каждый репозиторий содержит удобную таблицу всех проектов, с их названием, кратким описанием и ссылками на гитхаб / <a href="https://nbviewer.org">сторонний сервис nbviewer</a>. Эта же таблица продублирована ниже, в разделе **Реализованные проекты**.
